  ...
  return (
    <section id="Services" className="dark:bg-dark">
      <Container>
        {/* Header */}
        <motion.div
          className="-mx-4 flex flex-wrap mb-8"
          initial="hidden"
          whileInView="visible"
...
// ✅ Data separated for cleaner mapping
const services = [
  {
    title: "Web Design",
    details:
      "We craft visually stunning, user-friendly websites tailored to your brand, ensuring a seamless experience across all devices..",
    icon: <i className="fa fa-code"></i>,
  },
  {
    title: "Web Development",
    details:
      "We develop robust, scalable, and high-performing web applications tailored to your business needs using modern technologies.",
    icon: <i className="fa fa-file-code"></i>,
  },
  {
    title: "Mobile Development",
    details:
      "We create smooth, responsive mobile apps for iOS and Android, focused on performance and user experience.",
    icon: <i className="fa fa-external-link-alt"></i>,
  },
  {
    title: "Web Security",
    details:
      "We secure your digital assets with industry best practices, safeguarding your website from vulnerabilities and cyber threats.",
    icon: <i className="fas fa-user-secret"></i>,
  },
  {
    title: "Digital Marketing",
    details:
      "From SEO to social media, we help you grow your online presence, reach your audience, and boost your conversions.",
    icon: <i className="fa fa-envelope-open"></i>,
  },
  {
    title: "Automation",
    details:
      "We streamline your development and deployment processes with CI/CD pipelines, automation, and cloud infrastructure support.",
